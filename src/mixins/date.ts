...
export default class DateMixin extends Vue {
  ...
  disabledBeforeDate!: Date | string | number;

  @Prop({ type: [Date, String, Number], default: '' })
  disabledAfterDate!: Date | string | number;

  @Prop({ type: Array, default: () => [] })
  disabledRangeDate!: Array<Date | string | number>;

  @Prop({ type: Array, default: () => [] })
  disabledDate!: Array<Date | string | number>;
